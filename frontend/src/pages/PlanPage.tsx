...
export function PlanPage() {
  ...
  return (
    <div className="space-y-6 relative overflow-hidden min-h-[80vh]">
      ...
      <div 
        className="absolute inset-0 pointer-events-none bg-[url('/img3.jpg')] bg-contain bg-no-repeat bg-center opacity-[0.04] z-0" 
        aria-hidden="true" 
      />
        ...
        <Card className="space-y-4">
          <div className="flex flex-col justify-between gap-3 lg:flex-row lg:items-center">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="rounded-2xl bg-white shadow-[inset_0_2px_4px_rgba(255,255,255,0.7),4px_4px_10px_rgba(0,0,0,0.05)] border border-emerald-100 p-4 min-w-[100px]">
